...
function DgdCreateSocialButtons(box) {
    ...
    this.addFbButton = function () {
        ...
        if (typeof FB === 'object') {
            ...
            jQuery.getScript("//web.archive.org/web/20161204203540/http://connect.facebook.net/en_US/all.js#xfbml=1", function () {
                FB.init({status: true, cookie: true, xfbml: true});
            });
        }
    };
    ...
    this.addTwitterButton = function () {
        if (typeof twttr === 'object') {
            ...
            jQuery.getScript("//web.archive.org/web/20161204203540/http://platform.twitter.com/widgets.js");
        }

        this.ul.append('<li class="twitter ' + box.social.twitter + '"><a href="https://web.archive.org/web/20161204203540/https://twitter.com/share" data-url="' + $DGD.permalink + '" data-text="' + $DGD.title + '" class="twitter-share-button" >Tweet</a></li>');
    ...
    this.addGoogleButton = function () {
        if (typeof gapi === 'object') {
            ...
            jQuery.getScript("https://web.archive.org/web/20161204203540/https://apis.google.com/js/plusone.js");
        }
    ...
    this.addLinkedinButton = function () {
        ...
        if (typeof IN === 'undefined') {
            jQuery.getScript("//web.archive.org/web/20161204203540/http://platform.linkedin.com/in.js");
        }
    ...
    this.addStumbleuponButton = function () {
        jQuery.getScript("//web.archive.org/web/20161204203540/http://platform.stumbleupon.com/1/widgets.js");
    ...
    this.addPinterestButton = function () {
        jQuery.getScript("//web.archive.org/web/20161204203540/http://assets.pinterest.com/js/pinit.js");
        this.ul.append('<li class="pinterest ' + box.social.pinterest + '"><a href="https://web.archive.org/web/20161204203540/http://pinterest.com/pin/create/button/?url=' + $DGD.permalink + '&media=' + $DGD.thumbnail + '" class="pin-it-button" count-layout="' + box.social.pinterest + '"><img border="0" src="//web.archive.org/web/20161204203540/http://assets.pinterest.com/images/PinExt.png" title="Pin It" /></a></li>');
    };
...
/*
     FILE ARCHIVED ON 20:35:40 Dec 04, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:58:14 Nov 16, 2020.
...
playback timings (ms):
  ...
  CDXLines.iter: 23.902 (3)
  LoadShardBlock: 380.311 (3)
  PetaboxLoader3.datanode: 417.712 (4)
  RedisCDXSource: 49.539
  PetaboxLoader3.resolve: 36.551
  load_resource: 341.652
  exclusion.robots: 0.392
  captures_list: 459.029
*/